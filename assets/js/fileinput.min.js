+ function(e) {
    ...
    i.prototype.listen = function() {
        ...
        this.$preview.html("<img src='assets/img/headers/ebook-default/ebook_deft_img.jpg' class='img-responsive'/>"), this.$element.find(".fileinput-filename").text(""), this.$element.addClass("fileinput-new").removeClass("fileinput-exists"), void 0 !== e && (this.$input.trigger("change"), this.$element.trigger("clear.bs.fileinput"))
